...
def oneStepToPutBomb(potentialPath,potentialPathList,
    ...
    print("oneStepToPutBomb:powerups",powerups)
    print("oneStepToPutBomb:targetPosition",targetPosition)
    print("oneStepToPutBomb:player1indexes",player1indexes)
...
def explodingBombList(listOfBombs):
    # TODO:test this
    global currentBombWithTimestamp
    # var
    explodedBombs =[]
    # output
    explodingBombs = []
